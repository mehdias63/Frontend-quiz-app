...
export default function Home() {
	return (
		<main className="min-h-screen flex flex-col lg:flex-row items-center justify-center px-4 bg-gray-50 lg:gap-x-20 text-primary-900 leading-[2.5rem] lg:leading-[4rem] z-20 relative">
